...
assert_repo_install() {
  ...
  assert_contains "$target_repo/docs/workflow/config.yml" "prd_review:"
  assert_contains "$target_repo/docs/workflow/config.yml" "ticket_review:"
...
assert_contains "$migration_target/docs/workflow/config.yml" "prd_review:"
assert_contains "$migration_target/docs/workflow/config.yml" "ticket_review:"
